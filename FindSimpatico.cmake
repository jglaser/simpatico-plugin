...
if (SIMPATICO_MAIN_LIB AND SIMPATICO_UTIL_LIB)
    message(STATUS "Found Simpatico libraries: ${SIMPATICO_MAIN_LIB} ${SIMPATICO_UTIL_LIB}")
    mark_as_advanced(SIMPATICO_MAIN_LIB)
    mark_as_advanced(SIMPATICO_UTIL_LIB)
endif (SIMPATICO_MAIN_LIB AND SIMPATICO_UTIL_LIB)

set(SIMPATICO_FOUND FALSE)
if (SIMPATICO_SOURCE_DIR AND SIMPATICO_BIN_DIR AND SIMPATICO_ROOT AND SIMPATICO_MAIN_LIB AND SIMPATICO_UTIL_LIB)
    set(SIMPATICO_FOUND TRUE)
    mark_as_advanced(SIMPATICO_ROOT)
endif (SIMPATICO_SOURCE_DIR AND SIMPATICO_BIN_DIR AND SIMPATICO_ROOT AND SIMPATICO_MAIN_LIB AND SIMPATICO_UTIL_LIB)
...
set(SIMPATICO_LIBRARIES ${SIMPATICO_MAIN_LIB} ${SIMPATICO_UTIL_LIB})
